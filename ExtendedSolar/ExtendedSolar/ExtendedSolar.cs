...
public class CompPowerPlantAdvancedSolar : CompPowerPlant
{
	...
	protected override float DesiredPowerOutput => Mathf.Lerp(0f, 3400f, parent.Map.skyManager.CurSkyGlow) * RoofedPowerOutputFactor;
